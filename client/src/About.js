          ...
          <div className="row justify-content-center">
            <div className="col-lg-7 text-center  md-3 mt-3">
              ...
              <h2 className="faheading">
                We Advertisement Management,A creator's platform to meet brands and crack awesome
                deals.
              </h2>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col col-md-6 col-sm-12">
              <div className="team text-center">
                ...
                <div className="person-body">
                  <h3 className="staff-name">Gnaneswar</h3>
            ...
            <div className="col col-md-6 col-sm-12">
              <div className="team text-center">
                ...
                <div className="person-body">
                  <h3 className="staff-name">Preethi</h3>
                  <span className="d-block position mb-4">
                    Full stack Developer
                  </span>
                  <p className="mb-4">
            ...
            <div className="col col-md-6 col-sm-12">
              <div className="team text-center">
                <div className="mb-4 img-2"></div>
                <div className="person-body">
                  <h3 className="staff-name">Monika</h3>
                  <span className="d-block position mb-4">
                    Full stack Developer
                  </span>
                  <p className="mb-4">
